  ...
  return (
    <div>
      <div className='sm:container mx-auto'>
          ...
          <div className="flex space-x-2">
            {GRADES.map((grade, index) => (
              <button
                ...
                className={`flex-shrink-0 mx-1 px-3 py-1 border rounded ${selectedGrade === grade ? 'bg-blue-500 text-white' : 'bg-white text-black'}`}
              >
                Grade {index + 1}
              </button>
            ))}
            <button
              ...
              className={`flex-shrink-0 mx-1 px-3 py-1 border rounded ${selectedGrade === null ? 'bg-blue-500 text-white' : 'bg-white text-black'}`}
            >
              All
            </button>
          </div>
        ...
        {/* Search Filter */}
        <div className='mb-4 flex flex-wrap justify-between gap-2 sm:p-0 p-2 items-center'>
          ...
          <input
            ...
            className='px-3 py-1 border bg-primary text-white placeholder:text-white rounded-3xl'
          />
        </div>

        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:p-0 p-2'>
        ...
        <div className='flex justify-center mt-4 w-full'>
          {Array.from({ length: totalPages }, (_, i) => (
            <button
              ...
              className={`mx-1 px-3 py-1 border rounded ${currentPage === i + 1 ? 'bg-blue-500 text-white' : 'bg-white text-black'}`}
            >
              {i + 1}
            </button>
          ))}
