...
const SIngleCourse = ({ course }: { course: ICourseData }) => {
  ...
  return (
    <>
      <div className="w-full py-2 md:w-full h-full  bg-[#c9c8c8bd]  rounded-xl shadow-xl  mx-auto flex flex-col justify-between ">
        <div className="flex justify-center items-center  ">
          ...
          /> */}
          <Image alt="" width={1500} height={100} className="w-full h-[220px] rounded-md" src={(course?.img || arr[indexArray])} />
        ...
        <div className="flex flex-col justify-between h-1/2  mt-3">
          ...
          <div className="flex flex-col gap-2">
            <div className=" flex flex-row justify-between items-center text-xs sm:text-sm text-gray-900  gap-2 px-2 py-1">
              <span className="py-1  font-regular whitespace-nowrap  flex flex-row items-center justify-center bg-primary text-white p-2 rounded-md w-full">
                <CgPlayButtonO className="mr-1 text-white font-extrabold text-lg" />{" "}
                {course?.totalVideoSize} video
              </span>

              <span className="flex whitespace-nowrap justify-center items-center gap-1 bg-primary text-white  py-1 p-2 rounded-md w-full">
                <SnippetsOutlined
            ...
            <div className="w-full px-4 pb-4">
              <div className="w-full border-4 border-primary rounded-3xl p-1">
              <Button
              ...
              className="bg-primary  cursor-pointer rounded-3xl hover:text-primary font-bold  text-center flex justify-center items-center  w-full text-white text-lg    "
            >
              Enroll Now
            </Button>
              </div>
