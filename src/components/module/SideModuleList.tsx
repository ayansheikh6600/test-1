...
const SideModuleList = ({
  ...
  return (
    ...
    >
      <div
        className="relative bg-no-repeat bg-cover min-h-[3rem] flex items-center bg-[#8CA46D] "
        style={
          {
        ...
        {modulesData?.map((module: any, index: number) => {
          return (
            <Link
              ...
              className={`flex   text-start text-base lg:text-text-lg  leading-2   py-1 px-1 md:px-3 rounded ${
                module?._id === moduleId
                  ? "text-[#479FEC] front-bold"
