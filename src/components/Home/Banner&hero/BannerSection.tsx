...
const BannerSection = () => {
  ...
  return (
    ...
    <div className="w-full">
        <div className="w-full border-b-2 py-[30px]">
          <div className="grid md:grid-cols-2 w-[85%] mx-auto py-5 md:h-[480px]">
            <div>
            <Image alt="" width={1200} height={1200}  src={"/HeroChild.png"} className="pr-5 w-full  h-[400px]" />
            </div>
            ...
            <div className="">
              <Image alt="" width={1200} height={1200}  src={bannerBG} className="pr-5 w-full h-[400px] " />

              <h2 className="text-lg s sm:text-3xl lg:text-4xl mt-2 text-center">
